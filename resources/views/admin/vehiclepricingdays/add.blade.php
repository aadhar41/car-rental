...
<form action="{{ route('admin.vehiclepricing.store') }}" method="POST" enctype="multipart/form-data">
    {{ method_field('POST') }}
    @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="days" value="{{ old('days') }}" id="days" class="form-control {{ $errors->has('days') ? 'is-invalid' : '' }}" placeholder="Days" autocomplete="off" />
                            @if($errors->has('days'))
                            <div class="invalid-feedback">
